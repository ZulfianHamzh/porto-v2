  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`${className} absolute bottom-2 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md shadow-md pb-2 px-4`}
